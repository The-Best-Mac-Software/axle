...
void array_o_insert(ordered_array_t* array, type_t item) {
...
type_t array_o_lookup(ordered_array_t* array, uint32_t i) {
	return array_m_lookup(i, array->array);
}

uint16_t array_o_index(ordered_array_t* array, type_t item) {
	return array_m_index(item, array->array);
}

void array_o_remove(ordered_array_t* array, uint32_t i) {
